...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Quest game'),
    );
  }
}
            ...
            child: Column(
              ...
              children: [
                const Padding(
                  ...
                  child: Text("Select your hero class"),
                ),
                Padding(
                  padding:
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => const UnderworldScreen(),
                      ));
                    },
                    child: const Text("Mercenary"),
                  ),
                )
              ],
            )));
